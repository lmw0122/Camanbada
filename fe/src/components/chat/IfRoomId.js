...
const IfRoomId = (props) => {
  ...
  if (props.roomId === null) {
    ...
    return <MessageRoom roomId={props.roomId} userId={props.userId} nickname={props.nickname} oppUserId={props.oppUserId} oppNickname={props.oppNickname}></MessageRoom>
  }
}
