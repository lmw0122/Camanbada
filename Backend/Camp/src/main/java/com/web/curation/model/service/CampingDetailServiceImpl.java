...
public class CampingDetailServiceImpl implements CampingDetailService {
	...
	public CampingDetailDTO saveOneCampingDetail(CampingDetailDTO campingDetailDTO) {
		CampingDetailEntity campingDetailEntity = campingDetailHandler.saveOneCampingDetailEntity
				(campingDetailDTO);
	...
	@Override
	public CampingDetailDTO getOneCampingDetailById(Integer campId) {
		CampingDetailEntity campingDetailEntity = campingDetailHandler.getOneCampingDetailEntity(campId);
