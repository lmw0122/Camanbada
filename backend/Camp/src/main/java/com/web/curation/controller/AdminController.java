...
//	@Autowired
//	public AdminController(CampingBasicService campingBasicService) {
//		this.campingBasicService = campingBasicService;
//	}
	
	@ApiOperation(value = "캠핑장 기본 데이터 입력", notes = "캠핑장 기본 정보를 직접 입력하여 DB에 저장")
	@PostMapping(value = "/camp/data/basic")
	public CampingBasicDTO createCampingBaisc(@RequestBody CampingBasicDTO campingBasicDTO) {
...
//		return campingBasicService.saveCampingBasic(doNm, sigunguNm, facltNm, firstImageUrl, lineIntro, address, manageSttus, mapX, mapY, likes);
	...
	public CampingDetailDTO createCampingDetail(@RequestBody CampingDetailDTO campingDetailDTO) {
